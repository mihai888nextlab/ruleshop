...
> Served at **`/docs`** on this control plane (e.g. http://localhost:3001/docs).
...
- Rule model / canary / multi-tenancy — see `ARCHITECTURE.md` in the repo
- Blank SPA clone — `apps/storefront/README.md`
- Key rotation — store dashboard **Conexiune**
